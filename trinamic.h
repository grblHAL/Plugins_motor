...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & V_AXIS_BIT)
#ifndef TMC_V_ENABLE
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & W_AXIS_BIT)
#ifndef TMC_W_ENABLE
#define TMC_W_ENABLE 0
#endif
#else
#define TMC_W_ENABLE 1 // Do not change
#endif
#define TMC_W_MONITOR 1
#define TMC_W_MICROSTEPS TRINAMIC_DEFAULT_MICROSTEPS
#define TMC_W_R_SENSE R_SENSE // mOhm

#ifndef TMC_W_CURRENT
#define TMC_W_CURRENT DEFAULT_W_CURRENT // mA RMS
#endif
#ifndef TMC_W_HOLD_CURRENT_PCT
#define TMC_W_HOLD_CURRENT_PCT 50
#endif
#define TMC_W_HOMING_SEEK_SGT 22
#define TMC_W_HOMING_FEED_SGT 22
#define TMC_W_STEALTHCHOP TMC_STEALTHCHOP
